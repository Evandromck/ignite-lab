        ...
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex-1">
                       ...
                       <div className="flex items-center gap-4 mt-6">
                        <img 
                           ...
                           src="https://avatars.githubusercontent.com/u/64655153?v=4"
                           alt=""
                           />
                         <div className="leading-relaxed">
                         <strong className="font-bold text-2x1 block">Evandro Araujo</strong>
                         <span className="text-gray-200 text-sm block">CTO at lesson</span>
                         </div>
                       </div>
                    </div>
                    ...
                    <a href="" className="p-4 text-sm bg-green-800 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-600 transition-colors">
                      <DiscordLogo size={24} />
